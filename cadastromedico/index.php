        ...
        <tr>
          ...
          <td class="d-flex flex-row">
            <form class="m-0" action="alterar_medico.php" method="POST">
              <button type="submit" class="btn-ed" name="id" id="id" value="<?= $medico['id'] ?>">Editar</button>
            </form>

            <form class="m-0 ms-1" action="excluir_medico.php" method="POST">
              <button type="submit" class="btn-del" name="id" id="id" value="<?= $medico['id'] ?>">Excluir</button>
            </form>
          </td>
        </tr>
      <?php } ?>
